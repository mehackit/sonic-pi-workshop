---
chapter: Claves, acordes y escalas
title: Claves, acordes y escalas
lang: es
layout: exercise
---

A veces componer una melodía con Sonic Pi puede ser engorroso, sobre todo si no sabes inmediatamente como suenan los sonidos `62` o `:c3`. Si quieres, puedes seleccionar una escala desde la pestaña del menú para ver que teclas podrían sonar bien con una tecla concreta. 
...
<div class="keyboard-options">
  ...
  <div class="keyboard-options">
    ...
    <i>(Use las flechas izquierda/derecha para ajustar con el teclado)</i>
    <p>Sintetizador de Audio, creado por <a href="http://www.keithwhor.com/">Keith William Horwood</a></p>
    </small>
  </div>
</div>

## ¿Qué acordes y notas tocar?

Naturalmente que puede tocar cualesquiera de las notas y acordes que quieras. No hay correcto o erróneo. La música no tiene porqué sonar armónica, y algo de disonancia o ruido puede formar parte de las pistas tanto como quiera el artista. Sin embargo, hay algunas normas que puedes probar si quieres.

Si tu composición está en un tono concreto, digamos por ejemplo en Do mayor, tienes ciertos acordes que probablemente sonarán bien en la pista. Aquí tenemos una tabla con algunos acordes llamativos que deberían sonar bastante bien entre ellos. Si quieres puedes mirar más acordes progresivos aquí: <a href="http://www.lotusmusic.com/chord-progression-map.html">lotusmusic.com/chord-progression-map.html</a>
